      ...
      <div className="relative z-10 h-full px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full group">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-white/40 group-focus-within:text-green-400 transition-colors" />
            <Input
              placeholder="Search vehicles, parts, customers..."
              className="pl-10 bg-white/5 border-white/20 text-white placeholder:text-white/40 focus:border-green-400/50 focus:bg-white/10 transition-all duration-300"
            />
            <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-green-500/0 to-emerald-500/0 group-focus-within:from-green-500/10 group-focus-within:to-emerald-500/10 transition-all duration-300 pointer-events-none"></div>
          </div>
        </div>
