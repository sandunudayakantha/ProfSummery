...
const pieData = [
  { name: 'Available', value: 65, color: '#06b6d4' },
  { name: 'Rented', value: 25, color: '#8b5cf6' },
              ...
              <GlassCard glow gradient={kpi.gradient as any} className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`p-3 rounded-xl bg-gradient-to-r ${
                    kpi.gradient === 'blue' ? 'from-blue-500/20 to-cyan-500/20' :
                    kpi.gradient === 'purple' ? 'from-purple-500/20 to-pink-500/20' :
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData}>
                  ...
                  />
                  <Area type="monotone" dataKey="sales" stroke="#06b6d4" fill="rgba(6,182,212,0.2)" />
                  <Area type="monotone" dataKey="rentals" stroke="#8b5cf6" fill="rgba(139,92,246,0.2)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </GlassCard>
            ...
            {recentActivities.map((activity) => (
              ...
              >
                <div className={`w-2 h-2 rounded-full ${
                  activity.type === 'rental' ? 'bg-blue-400' :
                  activity.type === 'parts' ? 'bg-purple-400' :
